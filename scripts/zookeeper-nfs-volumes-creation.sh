...
usage() {
  logIt ""
  logIt "Usage: ./zookeeper-nfs-volumes-creation.sh [OPTION]"
  logIt "Must not be used in production. It will do:"
  logIt "Install and set up a basic NFS server configuration"
  logIt "Create the pv.yml and pvc.yml of: https://github.ibm.com/connections/deploy-services/tree/master/microservices/hybridcloud/templates/zookeeper"
  logIt ""
